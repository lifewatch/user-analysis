...
NAME = 'lw_pub_statistics'
DESCRIPTION = 'Describe the project.'
URL = 'http://www.vliz.be/'
EMAIL = 'laurian.van.maldeghem@vliz.be'
AUTHOR = 'Van Maldeghem Laurian'
LICENSE = 'MIT'
CONSOLE_SCRIPTS = ['lw_pub_statistics = lw_pub_statistics.__main__:main']
TROVE_CLASSES = [
    # Trove classifiers
